  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-paper/80 backdrop-blur-sm p-7 rounded-xl border border-border relative overflow-hidden">
      ...
      <form action="/api/auth/login" method="POST" className="space-y-4">
        <button
          type="submit"
          className="press w-full inline-flex items-center justify-center gap-2.5 h-10 px-4 bg-sumi border border-border rounded-(--radius-control) text-ink text-footnote font-medium hover:bg-kinu transition-colors"
        >
